...
function increasePrices(percentage) {
  // seu código aqui
  const adult = (percentage / 100 * prices.Adult) + prices.Adult;
  const child = (percentage / 100 * prices.Child) + prices.Child;
  const senior = (percentage / 100 * prices.Senior) + prices.Senior;
