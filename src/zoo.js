...
function increasePrices(percentage) {
  return {
    Adult: Math.round((prices.Adult += prices.Adult *= percentage / 100) *100) /100,
    Child: prices.Child += prices.Child *= percentage / 100,
    Senior: prices.Senior += prices.Senior *= percentage /100
  }
}
