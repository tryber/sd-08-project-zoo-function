...
function entryCalculator(entrants) {
  ...
  console.log(` ${received} = ${Adult}  x ${data.price.Adult} `)
  received += Adult*data.price.Adult;
  console.log(` ${received} = ${Child}  x ${data.price.Senio} `)
  received += data.price.Child*Child;
  received += data.price.Senior*Senior;
