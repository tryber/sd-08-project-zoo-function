...
function entryCalculator(entrants) {
  ...
  const {prcceAdult, priceChild, priceSenior} = data.prices;
  console.log(entrants)
  console.log(received)
  console.log(` ${received} ${Adult}  x ${prcceAdult} `)
  received += Adult*prcceAdult;
  console.log(` ${received} ${Child}  x ${priceChild} `)
  received += priceChild*Child;
  received += priceSenior*Senior;
  console.log(received)
