...
function entryCalculator(entrants) {
  ...
  // }
  const {Adult = 1, Child = 1, Senior = 1} = entrants;
  const zooPrices = data.prices;
  const {priceAdult, priceChild, priceSenior} = zooPrices;
  console.log(data.prices)
  console.log(received)
  console.log(priceAdult)
  console.log(` ${received} = ${Adult}  x ${data.prices.Adult} `)
  received += data.prices.Adult*Adult;
  console.log(` ${received} = ${Child}  x ${data.prices.Child} `)
  received += data.prices.Child*Child;
  console.log(` ${received} = ${Senior}  x ${data.prices.Senior} `)
