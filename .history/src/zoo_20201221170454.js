...
function oldestFromFirstSpecies(id) {
  ...
  firstAnimalID = data.employees.find( employee => employee.id === id).responsibleFor[0];
  AnimalsList = animals.find(animal => animal.id === firstAnimalID).residents;
  AnimalsList.sort((animal,bnimal) => animal.age - bnimal.age);
